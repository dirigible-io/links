linksApp.controller('ManageController', ['$scope', '$http', '$sce', function($scope, $http, $sce) {
    ...
    $('#search-category1').click(function () {
        $scope.searchGroup = changeSearchGroup(this, $scope.searchGroup);
    });
    $('#search-category2').click(function () {
        $scope.searchGroup = changeSearchGroup(this, $scope.searchGroup);
    });
    $('#search-category3').click(function () {
        $scope.searchGroup = changeSearchGroup(this, $scope.searchGroup);
    });
    
    $('#search-category3').click();
